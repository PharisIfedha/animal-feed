    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
        <form class="form" action="signup.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group <?php echo isset($errors['zip_code']) ? 'has-error' : '' ?>">
              <label class="control-label">Zip Code</label>
              <input type="text" name="zip_code" value="<?php echo $zip_code; ?>" class="form-control">
              <?php if (isset($errors['zip_code'])): ?>
                <span class="help-block"><?php echo $errors['zip_code'] ?></span>
              <?php endif; ?>
          </div>
          ...
          <div class="form-group" style="text-align: center;"> Add profile picture here.<br>
